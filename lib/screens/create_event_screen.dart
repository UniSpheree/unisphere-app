...
class _CreateEventScreenState extends State<CreateEventScreen> {
  ...
  Future<void> _submitForm() async {
    // Consider route-provided user as logged in as well (caller may pass 'user').
    final routeUser = (ModalRoute.of(context)?.settings.arguments as Map?)?['user'];
    final isLoggedIn = routeUser != null || MockBackend().currentUser != null;
    ...
    // In create mode, navigate to dashboard only when logged in; otherwise
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: _bannerImage == null ? _pickBannerImage : null,
                          ...
                          Padding(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              items: eventCategories
                                  ...
                                  .toList(),
                              onChanged: (value) => setState(() => eventCategory = value),
                              validator: (value) {
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: visibilityOptions.map((option) {
                                final isSelected = eventVisibility == option['value'];
                                return Expanded(
                                  child: GestureDetector(
                                    onTap: () => setState(() => eventVisibility = option['value']),
                                    child: AnimatedContainer(
                                      duration: const Duration(milliseconds: 200),
                                      margin: EdgeInsets.only(
                                        right: option['value'] != 'Restricted' ? 8 : 0,
                                      ),
                                      padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 8),
                                      decoration: BoxDecoration(
                                        color: isSelected ? Colors.indigo.withOpacity(0.08) : const Color(0xFFF7F9FC),
                                        borderRadius: BorderRadius.circular(12),
                                        border: Border.all(
                                      ...
                                      child: Column(
                                        children: [
                                          Icon(option['icon'] as IconData, color: isSelected ? Colors.indigo : Colors.grey, size: 22),
                                          const SizedBox(height: 4),
                                          Text(
                              ...
                              ? Column(
                                  children: [
                                    _textField(
                                      ...
                                      validator: (value) {
                                        if (value == null || value.trim().isEmpty) return 'Venue or Link is required';
                                        return null;
                                      },
                                    ),
                                    _textField(
                                      ...
                                      validator: (value) {
                                        if (value == null || value.trim().isEmpty) return 'Max Attendees is required';
                                        if (int.tryParse(value.trim()) == null) return 'Max Attendees must be a number';
                                        if (int.parse(value.trim()) < 1) return 'Max Attendees must be at least 1';
                                        return null;
                                      },
                                    ),
                                  ],
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: Text(
                                _isSubmitting
                                    ? (widget.isEditing ? 'Saving Changes...' : 'Creating Event...')
